<table>
    <thead>
        <tr>
            <th colspan="8" style="font-size: 14px; font-weight: bold; text-align: center;">LAPORAN DATA SURAT KELUAR</th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th style="font-weight: bold; background-color: #dcdcdc; border: 1px solid #000000;">Tujuan Surat</th>
            ...
            <th style="font-weight: bold; background-color: #dcdcdc; border: 1px solid #000000;">Petugas Pembuat</th>
        </tr>
    </thead>
    <tbody>
        @foreach($suratKeluar as $index => $surat)
            <tr>
                ...
                <td style="border: 1px solid #000000;">{{ $surat->tujuan_surat }}</td>
