<x-app-layout>
    <div class="animate-fade-in-up space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-extrabold text-gray-800 tracking-tight">Tambah Klasifikasi Surat</h2>
                <p class="text-sm text-gray-500 mt-1">Buat kode klasifikasi baru untuk pengarsipan surat.</p>
            </div>
            ...
            <form action="{{ route('klasifikasi.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="kode_klasifikasi" id="kode_klasifikasi" value="{{ old('kode_klasifikasi') }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_klasifikasi" id="nama_klasifikasi" value="{{ old('nama_klasifikasi') }}" required
                ...
                <div>
                    ...
                    <textarea name="uraian" id="uraian" rows="4"
                              ...
                              placeholder="Tuliskan penjelasan singkat mengenai kode klasifikasi ini...">{{ old('uraian') }}</textarea>
                    @error('uraian')
                        <p class="text-red-500 text-xs font-semibold mt-1">{{ $message }}</p>
                    @enderror
                </div>
