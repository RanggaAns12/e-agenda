<x-app-layout>
    <div class="animate-fade-in-up space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-extrabold text-gray-800 tracking-tight">Tambah Surat Keluar</h2>
                <p class="text-sm text-gray-500 mt-1">Isi formulir berikut untuk mencatat dokumen surat keluar baru.</p>
            </div>
